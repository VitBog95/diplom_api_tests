...
def auth_headers():
    ...
    return {"Cookie": f"token_global={MY_TOKEN}", "Content-Type": "application/json"}


@pytest.fixture
def created_lesson_id(auth_headers):
    """Создает урок и возвращает его числовой ID"""
    ...
    print(f"✅ Фикстура создала урок с ID: {lesson_id}")
